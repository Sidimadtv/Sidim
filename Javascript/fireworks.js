...
var Fireworks = (function() {
  ...
  function initialize() {
    ...
    document.addEventListener('load', createFirework, true);
  ...
  function createFirework() {
    ...
    {
        createParticle();
        document.getElementById('fWAudio').play();
        x++;
    }
    else{
  ...
  function clearContext() {
    mainContext.fillStyle = "rgba(0.9,0.2,0.8,0.8)";
    mainContext.fillRect(0, 0, viewportWidth, viewportHeight);
       var img=document.getElementById("canvasBG");
    img.src = 'icons/bg3.jpg';
    mainContext.drawImage(img, 0, 0);
      mainContext.font="150px Verdana";
      var textColor = "white";
       mainContext.fillStyle=textColor;
       mainContext.shadowOffsetX = 7;
       mainContext.shadowOffsetY = 1;
       mainContext.shadowBlur = 3;
    
       mainContext.fillText("YOU Won",300,250);
       mainContext.font="70px Verdana";
       var textColor = "yellow";
          mainContext.fillStyle=textColor;
      mainContext.fillText("$1,000,000",500,350);
  }
